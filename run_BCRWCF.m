function run_BCRWCF(CombinedViewingBehaviorData,saliencemapfile,tagname,imageX,imageY,plotoptions,IOR_tau)
...
%    'fixations','fixationorder','fixationtimes','IOR_tau')

save([tagname '-' saliencemapfile(1:dash-1) '-BCRW.mat'],'alltrials',...
    'fixations','fixationorder','fixationtimes','IOR_tau')
end